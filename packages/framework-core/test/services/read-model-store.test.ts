...
describe('ReadModelStore', () => {
  ...
  config.entities[AnImportantEntity.name] = {
    class: AnImportantEntity,
    authorizer: BoosterAuthorizer.authorizeRoles.bind(null, []),
  }
  config.entities[AnEntity.name] = { class: AnEntity, authorizer: BoosterAuthorizer.authorizeRoles.bind(null, []) }
